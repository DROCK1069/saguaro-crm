          ...
          <div style={{
            ...
            <div
              ...
              style={{
                ...
                background: '#0d1117', backdropFilter: 'blur(2px)',
              }}
            />
            {/* Drawer panel */}
            <div style={{
              ...
              <div style={{
                ...
                display: 'flex', gap: 10, position: 'sticky', bottom: 0, background: '#0F172A',
              }}>
                <button onClick={() => { clearAllFilters(); }} style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 10 }}>
            <div>
              ...
              <select value={newSpec} onChange={(e) => setNewSpec(e.target.value)} style={inp}>
                {SPEC_SECTIONS.map((s) => <option key={s} value={s} style={{ background: '#0F172A' }}>{s}</option>)}
              </select>
            </div>
            <div>
