'use client';
/**
 * Saguaro Control Systems — RFI View / Respond
      ...
      <div style={{ padding: '18px 16px' }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 10 }}>
          <button onClick={() => setDrawerOpen(true)} style={{
            background: activeFilterCount > 0 ? 'rgba(245, 158, 11,.15)' : 'transparent',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                position: 'sticky', top: 0, background: '#141416', zIndex: 1,
              }}>
              ...
              <div style={{
                ...
                display: 'flex', gap: 10, position: 'sticky', bottom: 0, background: '#141416',
              }}>
                <button onClick={() => { clearAllFilters(); }} style={{
              ...
              <div style={{ background: RAISED, border: `1px solid ${BORDER}`, borderRadius: 16, padding: 24, width: '100%', maxWidth: 400 }}>
                ...
                <div style={{ display: 'flex', gap: 10, marginTop: 16 }}>
                  ...
                  <button onClick={handleBulkReassign} disabled={bulkProcessing || !reassignTo.trim()} style={{
                    flex: 1, background: bulkProcessing ? 'rgba(255,255,255,0.12)' : BLUE, border: 'none', borderRadius: 10,
      ...
      <div style={{ padding: '18px 16px' }}>
        ...
        <form onSubmit={handleRespond} style={{ background: RAISED, border: `1px solid ${BORDER}`, borderRadius: 14, padding: '14px', marginBottom: 14 }}>
          ...
          <button type="submit" disabled={submitting} style={{
            width: '100%', background: submitting ? 'rgba(255,255,255,0.12)' : GREEN, border: 'none', borderRadius: 14,
  ...
  return (
    <div style={{ padding: '18px 16px' }}>
      ...
      <form onSubmit={handleCreate}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 10 }}>
            <div>
              ...
              <select value={newSpec} onChange={(e) => setNewSpec(e.target.value)} style={inp}>
                {SPEC_SECTIONS.map((s) => <option key={s} value={s} style={{ background: '#141416' }}>{s}</option>)}
              </select>
            </div>
            <div>
        ...
        <button type="submit" disabled={submitting} style={{
          width: '100%', background: submitting ? 'rgba(255,255,255,0.12)' : PURPLE, border: 'none', borderRadius: 14,
