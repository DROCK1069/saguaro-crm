'use client';
/**
 * Saguaro Control Systems — Push Notification Subscription UI
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <button
            ...
            style={{
              ...
              background: prefs.enabled ? GREEN : '#1c1c1e', position: 'relative', transition: 'background .3s',
              flexShrink: 0,
            }}
          >
            <div style={{
          ...
          <div key={cat.id} style={{
            ...
            <button
              ...
              style={{
                ...
                background: prefs.categories[cat.id] ? GOLD : '#1c1c1e', position: 'relative',
