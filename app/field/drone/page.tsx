'use client';
/**
 * Saguaro Control Systems — Drone Photo Analysis
...
function DronePage() {
            ...
            <div key={areaName} style={{ ...glass, padding: 14, marginBottom: 8 }}>
              ...
              <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ height: 6, background: 'rgba(255,255,255,0.08)', borderRadius: 3, overflow: 'hidden' }}>
                    <div style={{ height: '100%', width: `${pct1}%`, background: 'rgba(245,158,11,0.5)', borderRadius: 3 }} />
                  </div>
      ...
      <div style={{ padding: '12px 14px 100px', maxWidth: 480, margin: '0 auto' }}>
        ...
        <div style={{ ...glass, padding: 16, marginBottom: 12 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
            ...
            <span style={{
              background: `rgba(${STATUS_COLORS[selectedJob.status] === GREEN ? '34,197,94' : STATUS_COLORS[selectedJob.status] === BLUE ? '59,130,246' : STATUS_COLORS[selectedJob.status] === RED ? '239,68,68' : '245, 158, 11'},0.15)`,
  ...
  return (
    <div style={{ padding: '12px 14px 100px', maxWidth: 480, margin: '0 auto' }}>
      ...
      {/* Tabs */}
      <div style={{ display: 'flex', gap: 4, marginBottom: 16, background: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 3 }}>
            ...
            <>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                ...
                <button onClick={resetUpload}
                  style={{ background: 'rgba(255,255,255,0.08)', border: `1px solid ${BORDER}`, borderRadius: 10, padding: '6px 14px', color: DIM, fontSize: 12, cursor: 'pointer', fontWeight: 600 }}>
                  New Upload
                </button>
              </div>
            ...
            <>
              ...
              <div
                ...
                style={{
                  ...
                  background: dragActive ? 'rgba(245, 158, 11,0.06)' : CARD_GLASS,
                  transition: 'all 0.2s',
                }}>
                {photos.length === 0 ? (
                  <>
                    <div style={{ marginBottom: 10, opacity: 0.4, display: 'flex', justifyContent: 'center' }}><Camera size={40} weight="regular" /></div>
        ...
        <>
          ...
          {jobs.filter(j => j.status === 'complete').length >= 2 && (
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: 10 }}>
              <button onClick={() => { setCompareMode(!compareMode); setCompareSelections([]); }}
                style={{
                  background: compareMode ? 'rgba(245,158,11,0.15)' : 'rgba(255,255,255,0.06)',
                  border: `1px solid ${compareMode ? 'rgba(245,158,11,0.3)' : BORDER}`,
          ...
          {compareMode && compareSelections.length === 2 && (
            <button onClick={handleCompare}
              style={{
                ...
                background: `linear-gradient(135deg, ${BLUE}, #B45309)`,
            ...
            <div>
              {[1, 2, 3].map(i => (
                <div key={i} style={{ ...glass, padding: 16, marginBottom: 10 }}>
                  <div style={{ height: 16, width: '50%', background: 'rgba(255,255,255,0.08)', borderRadius: 8, marginBottom: 10 }} />
                  <div style={{ height: 12, width: '70%', background: 'rgba(255,255,255,0.06)', borderRadius: 6, marginBottom: 8 }} />
                  <div style={{ height: 10, width: '40%', background: 'rgba(255,255,255,0.06)', borderRadius: 5 }} />
                </div>
              ))}
            </div>
          )}
          ...
          {!jobsLoading && jobs.length === 0 && (
            <div style={{ ...glass, padding: 40, textAlign: 'center' }}>
              <div style={{ marginBottom: 12, opacity: 0.3, display: 'flex', justifyContent: 'center' }}><Airplane size={48} weight="regular" /></div>
            ...
            return (
              <div key={job.id}
                ...
                style={{
                  ...
                  background: isSelected ? 'rgba(245,158,11,0.08)' : CARD_GLASS,
                }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
                  <div style={{ flex: 1, minWidth: 0, display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                    {compareMode && (
                      <div style={{
                        ...
                        border: `2px solid ${isSelected ? BLUE : 'rgba(255,255,255,0.2)'}`,
                  ...
                  <span style={{
                    background: `rgba(${STATUS_COLORS[job.status] === GREEN ? '34,197,94' : STATUS_COLORS[job.status] === BLUE ? '59,130,246' : STATUS_COLORS[job.status] === RED ? '239,68,68' : '245, 158, 11'},0.15)`,
...
function LoadingSkeleton() {
  return (
    <div style={{ padding: '12px 14px', maxWidth: 480, margin: '0 auto' }}>
      <div style={{ height: 22, width: '50%', background: 'rgba(255,255,255,0.08)', borderRadius: 8, marginBottom: 16 }} />
      {[1, 2, 3].map(i => (
        <div key={i} style={{
          ...
          <div style={{ height: 16, width: '50%', background: 'rgba(255,255,255,0.08)', borderRadius: 8, marginBottom: 10 }} />
          <div style={{ height: 12, width: '70%', background: 'rgba(255,255,255,0.06)', borderRadius: 6 }} />
        </div>
      ))}
    </div>
  );
