'use client';
/**
 * Saguaro Control Systems — Project Directory
  ...
  return (
    <div style={{ padding: '18px 16px', maxWidth: 700, margin: '0 auto' }}>
      <FieldPageHeader
        ...
        actions={<button onClick={() => { resetForm(); setView('create'); }} style={{ ...btnPrimary, padding: '8px 16px', fontSize: 13 }}>+ Add</button>}
      />
        ...
        <div>
          ...
          <div style={{ ...card, marginBottom: 16 }}>
            ...
            <div style={{ marginBottom: 10 }}>
              ...
              <div style={{ maxHeight: 180, overflowY: 'auto', border: `1px solid ${BORDER}`, borderRadius: 10, padding: 8, background: '#1c1c1e' }}>
