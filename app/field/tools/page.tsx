...
function ToolsPage(){
  ...
  return(
    <div style={{padding:'18px 16px'}}>
      <h1 style={{margin:'0 0 4px',fontSize:22,fontWeight:800,color:TEXT}}>Tools</h1>
      <p style={{margin:'0 0 16px',fontSize:14,color:DIM}}>Everything on this job — organized</p>
...
export default function FieldToolsPage(){
  return <Suspense fallback={<div style={{padding:32,color:'#8BAAC8',textAlign:'center'}}>Loading...</div>}><ToolsPage/></Suspense>;
}
