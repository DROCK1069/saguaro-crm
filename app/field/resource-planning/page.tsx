'use client';
/**
 * Saguaro Control Systems — Resource Planning
...
const AMBER = '#F59E0B', BLUE = '#F59E0B', PURPLE = '#8B5CF6';
  ...
  return (
    <div style={{ minHeight: '100dvh', background: BG, color: TEXT, fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif', paddingBottom: 100 }}>
      ...
      <FieldPageHeader
        ...
        subtitle={`${projectName || 'Project'} · ${todayDisplay()}`}
        icon={scopedFieldIcon('schedule', 'ph')}
      />
...
export default function Page() {
  return (
    <Suspense
      fallback={
        <div style={{ minHeight: '100dvh', background: '#0a0a0a', color: '#CBD5E1', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>
