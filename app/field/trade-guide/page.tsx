...
const TRADE_COLORS: Record<string, string> = {
  'Low Volt': '#F59E0B', 'Electrical': '#F59E0B', 'Plumbing': '#06B6D4', 'HVAC': '#8B5CF6',
...
export default function TradeGuidePage() {
  ...
  const renderMarkdown = (md: string) => {
    if (!md) return '';
    return md
      .replace(/### (.*)/g, '<h3 style="color:#FFFFFF;font-size:16px;font-weight:700;margin:16px 0 8px">$1</h3>')
      .replace(/## (.*)/g, '<h2 style="color:#FFFFFF;font-size:18px;font-weight:700;margin:20px 0 10px">$1</h2>')
      .replace(/# (.*)/g, '<h1 style="color:#FFFFFF;font-size:22px;font-weight:700;margin:24px 0 12px">$1</h1>')
      .replace(/\*\*(.*?)\*\*/g, '<strong style="color:#FFFFFF">$1</strong>')
      .replace(/\*(.*?)\*/g, '<em>$1</em>')
      .replace(/`(.*?)`/g, '<code style="background:#1c1c1e;padding:2px 6px;border-radius:4px;font-size:12px;color:#22C55E">$1</code>')
      ...
      <div style={{ padding: '16px 16px 100px', maxWidth: 800, margin: '0 auto' }}>
        ...
        <button
          ...
          style={{
            ...
            borderRadius: '50%', background: `linear-gradient(135deg, ${GOLD}, #FBBF24)`,
          ...
          <div style={{
            ...
            <div style={{ padding: 12, borderTop: `1px solid ${BORDER}`, display: 'flex', gap: 8 }}>
              ...
              <button onClick={sendChat} disabled={chatLoading || !chatInput.trim()} style={{
                padding: '10px 16px', background: `linear-gradient(135deg, ${GOLD}, #FBBF24)`,
  ...
  return (
    <div style={{ padding: '16px 16px 100px', maxWidth: 800, margin: '0 auto' }}>
      ...
      <FieldPageHeader
        ...
        subtitle="How-tos, code references, and best practices for every trade."
