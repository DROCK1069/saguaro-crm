'use client';
/**
 * Saguaro Control Systems — Schedule View
                ...
                <div key={task.id} style={{ position: 'absolute', top: top + HEADER_HEIGHT, left: 0, width: timelineWidth, height: ROW_HEIGHT, borderBottom: `1px solid ${BORDER}` }}>
                  ...
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: 2,
                      cursor: 'pointer',
                      boxShadow: task._isCritical ? `0 0 6px rgba(239,68,68,.5)` : `0 0 4px rgba(245, 158, 11,.4)`,
                    }}
                  />
                </div>
              );
...
function SchedulePage() {
    ...
    return (
      <div style={{ padding: '18px 16px' }}>
        ...
        <div style={{ background: RAISED, border: `1px solid ${BORDER}`, borderRadius: 18, padding: '24px 20px', marginBottom: 16, textAlign: 'center' }}>
          ...
          {/* Progress bar */}
          <div style={{ height: 8, background: '#1c1c1e', borderRadius: 4, marginBottom: 16 }}>
          ...
          <div style={{ marginBottom: 16 }}>
            <input
              ...
              style={{
                ...
                background: `linear-gradient(to right, ${GOLD} 0%, ${GOLD} ${pct}%, #1c1c1e ${pct}%, #1c1c1e 100%)`,
            ...
            {[25, 50, 75, 100].map((v) => (
              <button
                ...
                style={{
                  ...
                  background: pct === v ? (v === 100 ? GREEN : GOLD) : '#1c1c1e',
  ...
  return (
    <div style={{ padding: '18px 16px' }}>
      <FieldPageHeader title="Schedule" subtitle={projectName} icon={scopedFieldIcon('schedule', 'ph')} />
      ...
      <div style={{ display: 'flex', gap: 4, marginBottom: 10, background: '#1c1c1e', borderRadius: 10, padding: 4 }}>
        <button
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      borderLeft: task._isCritical ? `3px solid ${RED}` : `1px solid ${late ? 'rgba(239,68,68,.35)' : active ? 'rgba(245, 158, 11,.25)' : BORDER}`,
            ...
            {hasBaseline && (
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
                <button
                  ...
                  style={{
                    background: showBaseline ? 'rgba(245,158,11,.12)' : 'transparent',
...
export default function FieldSchedulePage() {
  return <Suspense fallback={<div style={{ padding: 32, color: '#CBD5E1', textAlign: 'center' }}>Loading...</div>}><SchedulePage /></Suspense>;
}
