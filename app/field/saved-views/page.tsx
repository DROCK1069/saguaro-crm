'use client';
/**
 * Saguaro Control Systems — Saved Views Manager
...
const MODULES = [
  ...
  { value: 'daily_logs', label: 'Daily Logs', route: '/field/log' },
...
export default function SavedViewsPage() {
  ...
  return (
    <div style={{ background: BASE, minHeight: '100vh', color: TEXT, fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <FieldPageHeader
        title="Saved Views"
        subtitle="Save and apply filter presets across all modules"
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                  {STATUS_OPTIONS.map(s => (
                    <button
                      ...
                      style={{
                        background: formStatuses.includes(s) ? 'rgba(245, 158, 11,0.15)' : '#1c1c1e',
