  ...
  return (
    <div style={{ padding: '18px 16px 32px' }}>
      ...
      <div style={{ background: RAISED, border: `1px solid ${BORDER}`, borderRadius: 14, padding: '16px', marginTop: 20 }}>
        ...
        {([
          [<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" width={20} height={20}><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>, 'Lightning fast', 'Opens instantly from home screen — no browser loading'],
          ...
          [<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" width={20} height={20}><rect x={5} y={2} width={14} height={20} rx={2} ry={2}/><line x1={12} y1={18} x2={12.01} y2={18}/></svg>, 'Full screen', 'No browser bars — feels like a native app'],
