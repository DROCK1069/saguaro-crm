    ...
    return (
      <div style={{ padding: '18px 16px', minHeight: '100vh', background: '#0d1117' }}>
        ...
        <div style={{ background: RAISED, border: `1px solid ${BORDER}`, borderRadius: 14, padding: 16 }}>
          ...
          {newAttachment && (
            <div style={{ marginBottom: 14, padding: '6px 10px', background: '#16243A', borderRadius: 8, border: `1px solid ${BORDER}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      ...
      <div style={{ padding: '18px 16px', minHeight: '100vh', background: '#0d1117' }}>
        ...
        <div style={{ background: RAISED, border: `1px solid ${overdue ? 'rgba(239,68,68,.4)' : BORDER}`, borderRadius: 14, padding: 16, marginBottom: 14 }}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <div style={{ flex: 1, textAlign: 'center', padding: '10px 0', background: '#16243A', borderRadius: 10, border: `1px solid ${BORDER}` }}>
            ...
            <div style={{ flex: 1, textAlign: 'center', padding: '10px 0', background: '#16243A', borderRadius: 10, border: `1px solid ${overdue ? 'rgba(239,68,68,.35)' : BORDER}` }}>
              ...
              {selected.revisions.map((rev, i) => (
                <div key={i} style={{ position: 'relative', paddingBottom: i < selected.revisions!.length - 1 ? 18 : 0 }}>
                  ...
                  <div style={{
                    ...
                    background: getStatusColor(rev.status), border: '2px solid #0F172A',
                  }} />
        ...
        {!reviewAction ? (
          ...
          <div style={{ background: RAISED, border: `1px solid ${BORDER}`, borderRadius: 14, padding: 16 }}>
            ...
            <textarea
              ...
              style={{ width: '100%', padding: '10px 12px', background: '#16243A', border: `1px solid ${BORDER}`, borderRadius: 10, color: TEXT, fontSize: 14, resize: 'vertical', outline: 'none', boxSizing: 'border-box' }}
            />
            <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
              <button
