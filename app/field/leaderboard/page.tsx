'use client';
/**
 * Saguaro Control Systems — Gamification Leaderboard
...
import { Shield, CheckCircle, Camera, Alarm, Medal } from '@phosphor-icons/react';
...
const TABS: { key: TabKey; label: string; icon: React.ReactNode }[] = [
  { key: 'safety_streak', label: 'Safety', icon: <Shield size={16} weight="fill" style={{ verticalAlign: 'middle' }} /> },
  { key: 'punch_closure', label: 'Punch', icon: <CheckCircle size={16} weight="fill" style={{ verticalAlign: 'middle' }} /> },
  { key: 'photo_score', label: 'Photos', icon: <Camera size={16} weight="fill" style={{ verticalAlign: 'middle' }} /> },
  { key: 'on_time', label: 'On-Time', icon: <Alarm size={16} weight="fill" style={{ verticalAlign: 'middle' }} /> },
];
...
function MedalIcon({ rank, size }: { rank: number; size: number }) {
  ...
  return <Medal size={size} weight="fill" color={color} style={{ verticalAlign: 'middle' }} />;
}
...
function ConfettiOverlay({ onDone }: { onDone: () => void }) {
  ...
  const colors = [GOLD, GREEN, '#F59E0B', RED, '#8B5CF6', '#F97316'];
...
export default function LeaderboardPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: BASE, padding: '16px 16px 100px' }}>
      ...
      <FieldPageHeader
        title="Leaderboard"
        subtitle="Team rankings & achievements"
        icon={scopedFieldIcon('leaderboard', 'ph')}
      />
            ...
            return (
              ...
              >
                ...
                <div style={{
                  ...
                  {medal ? (
                    <MedalIcon rank={entry.rank} size={14} />
                  ) : (
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <MedalIcon rank={entry.rank} size={22} />
