    ...
    <div style={{ padding: '18px 16px' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Section label="Site Conditions">
          ...
          <Field label="Weather">
            <select value={weather} onChange={(e) => setWeather(e.target.value)} style={inp}>
              {WEATHER_OPTS.map((o) => <option key={o} value={o} style={{ background: '#0F172A' }}>{o}</option>)}
            </select>
          </Field>
          <Row>
        ...
        <Section label="Work Performed">
          ...
          <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
            <button
              ...
              style={{ flex: 1, background: aiLoading ? '#16243A' : 'rgba(139,92,246,.15)', border: `1px solid rgba(139,92,246,.3)`, borderRadius: 10, padding: '10px', color: aiLoading ? DIM : PURPLE, fontSize: 13, fontWeight: 700, cursor: aiLoading ? 'wait' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}
            >
              {aiLoading ? (
        ...
        <button
          type="submit"
          disabled={saving}
          style={{ width: '100%', background: saving ? '#16243A' : GOLD, border: 'none', borderRadius: 14, padding: '18px', color: saving ? DIM : '#000', fontSize: 17, fontWeight: 800, cursor: saving ? 'wait' : 'pointer', marginTop: 4, letterSpacing: 0.3 }}
        >
...
function Section({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div style={{ background: '#0F172A', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 14, padding: '14px 14px 6px', marginBottom: 12 }}>
...
const inp: React.CSSProperties = { width: '100%', background: '#16243A', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 10, padding: '12px 14px', color: '#FFFFFF', fontSize: 15, outline: 'none' };
