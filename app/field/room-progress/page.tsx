...
const GOLD='#F59E0B',BASE='#0d1117',TEXT='#FFFFFF',DIM='#CBD5E1',GREEN='#22C55E',BLUE='#3B82F6',RED='#EF4444',BORDER='rgba(255,255,255,0.12)';
const glass:React.CSSProperties={background:'rgba(15,23,42,0.85)',backdropFilter:'blur(16px)',WebkitBackdropFilter:'blur(16px)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:16};
...
const HEAT=[{max:0,color:'#6E6E73'},{max:25,color:'#EF4444'},{max:50,color:'#F97316'},{max:75,color:'#EAB308'},{max:99,color:'#3B82F6'},{max:100,color:'#22C55E'}];
