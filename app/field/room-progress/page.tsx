...
const glass:React.CSSProperties={background:'rgba(255,255,255,0.85)',backdropFilter:'blur(16px)',WebkitBackdropFilter:'blur(16px)',border:'1px solid rgba(0,0,0,0.06)',borderRadius:16};
...
<div style={{height:8,background:'rgba(0,0,0,0.06)',borderRadius:6,overflow:'hidden'}}><div style={{height:'100%',width:avg+'%',background:heatColor(avg),borderRadius:6,transition:'width 0.4s'}}/></div>
...
{loading?(<div style={{display:'flex',flexDirection:'column',gap:8}}>{[1,2,3].map(i=><div key={i} style={{...glass,padding:16,height:80}}><div style={{background:'rgba(0,0,0,0.04)',borderRadius:8,height:14,width:'50%',marginBottom:8}}/><div style={{background:'rgba(0,0,0,0.03)',borderRadius:6,height:8,width:'100%'}}/></div>)}</div>
...
<div style={{height:5,background:'rgba(0,0,0,0.06)',borderRadius:4,overflow:'hidden',marginBottom:10}}><div style={{height:'100%',width:edit.percent_complete+'%',background:heatColor(edit.percent_complete),borderRadius:4,transition:'width 0.2s'}}/></div>
...
<style>{String.raw`input[type=range]{-webkit-appearance:none;height:6px;border-radius:4px;background:rgba(0,0,0,0.1);outline:none}input[type=range]::-webkit-slider-thumb{-webkit-appearance:none;width:18px;height:18px;border-radius:50%;cursor:pointer}`}</style>
</div>
);
}
