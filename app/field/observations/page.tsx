...
const inputStyle: React.CSSProperties = {
  background: '#16243A', border: `1px solid ${BORDER}`, borderRadius: 10,
          ...
          <div style={{ borderTop: `1px solid ${BORDER}`, paddingTop: 10, marginTop: 6 }}>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              ...
              <button onClick={saveCurrentPreset} disabled={!presetName.trim()} style={{
                background: presetName.trim() ? GOLD : '#16243A', border: 'none', borderRadius: 8,
      ...
      <div style={{ marginBottom: 16 }}>
        {newChecklist.map(item => (
          <div key={item.id} style={{
            ...
            background: '#16243A', borderRadius: 10, padding: '8px 12px',
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          ...
          <button onClick={() => fileInputRef.current?.click()} style={{
            width: 72, height: 72, background: '#16243A', border: `2px dashed ${BORDER}`,
