'use client';
/**
 * Saguaro Control Systems — Safety Incidents & Corrective Actions
...
const SEVERITY_COLORS = ['#F59E0B', '#22C55E', '#F59E0B', '#EF4444', '#DC2626'];
...
function SafetyPage() {
  ...
  const sfChipStyle: React.CSSProperties = { display: 'inline-flex', alignItems: 'center', gap: 4, background: 'rgba(245, 158, 11,.10)', border: `1px solid rgba(245, 158, 11,.35)`, borderRadius: 20, padding: '4px 10px', fontSize: 11, fontWeight: 600, color: GOLD, cursor: 'pointer', whiteSpace: 'nowrap' };
      ...
      <div style={{ padding: '18px 16px' }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 10 }}>
          <button onClick={toggleFilterDrawer} style={{
            background: showFilterPanel || sfActiveFilterCount > 0 ? 'rgba(245, 158, 11,.12)' : 'transparent',
          ...
          {(sfActiveFilterCount > 0 || sfSortKey !== 'date' || sfSortDir !== 'desc') && (
            <span style={{ marginLeft: 'auto', fontSize: 12, color: GOLD, fontWeight: 700, background: 'rgba(245, 158, 11,.08)', border: `1px solid rgba(245, 158, 11,.2)`, borderRadius: 8, padding: '4px 10px' }}>
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                <select value={sfSortKey} onChange={e => setSfSortKey(e.target.value as typeof sfSortKey)} style={{ ...inp, fontSize: 13, padding: '8px 12px', flex: 1 }}>
                  <option value="date" style={{ background: '#141416' }}>Date</option>
                  <option value="severity" style={{ background: '#141416' }}>Severity</option>
                  <option value="status" style={{ background: '#141416' }}>Status</option>
                </select>
                <button onClick={() => setSfSortDir(d => d === 'asc' ? 'desc' : 'asc')} style={{
                  background: 'rgba(245, 158, 11,.08)', border: `1px solid rgba(245, 158, 11,.3)`, borderRadius: 10,
            ...
            <div style={{ marginBottom: 14, borderTop: `1px solid ${BORDER}`, paddingTop: 12 }}>
              ...
              <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                ...
                <button onClick={() => applySfQuickPreset('this_week')} style={{
                  ...sfChipStyle, background: 'rgba(245,158,11,.10)', border: '1px solid rgba(245,158,11,.3)', color: BLUE,
                }}>This Week</button>
              </div>
            </div>
            ...
            <div style={{ borderTop: `1px solid ${BORDER}`, paddingTop: 12 }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                <button onClick={saveSfPreset} disabled={!sfPresetName.trim()} style={{
                  background: sfPresetName.trim() ? GOLD : 'rgba(255,255,255,0.12)', border: 'none', borderRadius: 8,
        ...
        {sfActiveFilterCount > 0 && (
          <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 10 }}>
            ...
            {(sfFilterDateFrom || sfFilterDateTo) && (
              <span style={{ ...sfChipStyle, background: 'rgba(245,158,11,.10)', border: '1px solid rgba(245,158,11,.3)', color: BLUE }}>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '32px 16px', color: DIM }}>
            ...
            <button onClick={clearSfFilters} style={{
              background: 'rgba(245, 158, 11,.12)', border: `1px solid rgba(245, 158, 11,.3)`, borderRadius: 10,
              ...
              <div style={{ background: RAISED, border: `1px solid ${BORDER}`, borderRadius: 16, padding: 24, width: '100%', maxWidth: 400 }}>
                ...
                <div style={{ display: 'flex', gap: 10 }}>
                  ...
                  <button onClick={handleBulkAssignCA} disabled={bulkProcessing || !bulkCADesc.trim()} style={{
                    flex: 1, background: bulkProcessing ? 'rgba(255,255,255,0.12)' : GOLD, border: 'none', borderRadius: 10,
        ...
        <div style={{ background: RAISED, border: `1px solid ${BORDER}`, borderRadius: 14, padding: '14px', marginBottom: 14 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
            ...
            <button
              ...
              style={{ background: 'rgba(245, 158, 11,.12)', border: `1px solid rgba(245, 158, 11,.3)`, borderRadius: 8, padding: '5px 12px', color: GOLD, fontSize: 12, fontWeight: 700, cursor: 'pointer' }}
            >
              + Add CA
            </button>
          </div>
    ...
    <div style={{ padding: '18px 16px' }}>
      ...
      <form onSubmit={handleCreateIncident}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 10 }}>
            ...
            <div>
              ...
              <select value={newType} onChange={(e) => setNewType(e.target.value)} style={inp}>
                {INCIDENT_TYPES.map((t) => <option key={t} value={t} style={{ background: '#141416' }}>{TYPE_LABELS[t]}</option>)}
              </select>
            </div>
          </div>
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          ...
          <button type="submit" disabled={saving} style={{ flex: 2, background: saving ? 'rgba(255,255,255,0.12)' : RED, border: 'none', borderRadius: 12, padding: '16px', color: saving ? DIM : '#fff', fontSize: 15, fontWeight: 800, cursor: saving ? 'wait' : 'pointer' }}>
