            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                <select value={sfSortKey} onChange={e => setSfSortKey(e.target.value as typeof sfSortKey)} style={{ ...inp, fontSize: 13, padding: '8px 12px', flex: 1 }}>
                  <option value="date" style={{ background: '#0F172A' }}>Date</option>
                  <option value="severity" style={{ background: '#0F172A' }}>Severity</option>
                  <option value="status" style={{ background: '#0F172A' }}>Status</option>
                </select>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 10 }}>
            ...
            <div>
              ...
              <select value={newType} onChange={(e) => setNewType(e.target.value)} style={inp}>
                {INCIDENT_TYPES.map((t) => <option key={t} value={t} style={{ background: '#0F172A' }}>{TYPE_LABELS[t]}</option>)}
              </select>
            </div>
          </div>
