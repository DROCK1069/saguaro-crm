    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-amber:hover { background: #E8940A; }
        .btn-outline {
        ...
        .btn-outline:hover { border-color: rgba(255,255,255,0.28); color: ${TEXT}; }
        .pain-card {
          background: transparent;
          border: none;
          border-radius: 0;
        ...
        .comparison-table tr:nth-child(even) td { background: rgba(255,255,255,0.03); }
      ...
      <section style={{
        ...
        {/* Subtle ambient warmth — single minimal accent */}
        <div style={{
        ...
        <div style={{ position: 'relative', maxWidth: 800, margin: '0 auto' }}>
          ...
          <h1 className="hero-headline" style={{
            fontSize: '1.9rem', fontWeight: 600, lineHeight: 1.2,
            letterSpacing: '-0.02em', marginBottom: 24, color: TEXT,
          }}>
          ...
          <p className="hero-sub" style={{
            fontSize: '0.98rem', color: DIM, lineHeight: 1.7,
          ...
          <div className="hero-ctas" style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/signup" className="btn-amber" style={{ padding: '11px 24px', fontSize: '0.95rem', borderRadius: 8 }}>
              Start Free Trial — No CC Required
            </Link>
            <a href="#comparison" className="btn-outline" style={{ padding: '11px 22px', fontSize: '0.95rem', borderRadius: 8 }}>
              See What We Offer ↓
            </a>
          </div>
          ...
          <div className="trust-pills">
            {['✓ 1-Day Migration', '✓ Free Data Import', '✓ Month-to-Month', '✓ No Contracts'].map((pill) => (
              <span key={pill} style={{
                ...
                border: `1px solid rgba(255,255,255,0.14)`,
                borderRadius: 999, padding: '6px 16px',
                fontSize: '0.8rem', fontWeight: 500, color: DIM,
              }}>
                {pill}
              </span>
            ))}
      ...
      {/* ─── PAIN POINTS ─── */}
      <section className="section-pad" style={{ padding: '96px 40px', background: RAISED }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            <h2 style={{ fontSize: '1.4rem', fontWeight: 600, marginBottom: 12, color: TEXT }}>
              Why Procore Users Are Switching
            </h2>
            <p style={{ color: DIM, marginTop: 8, fontSize: '0.95rem' }}>
          ...
          <div className="pain-grid">
            {[
              ...
              },
              {
                ...
                body: 'Procore\'s average implementation takes 4–6 months and requires a dedicated admin. We get you live fast — no consultants, no training contracts.',
              },
              {
                icon: '🤖',
              ...
              {
                icon: '📱',
                title: 'Field Access Is a Paid Add-On',
                body: 'Procore charges extra for field access on top of per-seat pricing — plus IT approval and device management. Saguaro Control Systems is a free native iOS app, included for your whole crew.',
              },
              {
                icon: '📄',
              ...
              <div key={card.title} className="pain-card">
                <div style={{
                  ...
                  <h3 style={{ fontSize: '0.95rem', fontWeight: 600, color: TEXT, lineHeight: 1.3 }}>
                    {card.title}
                  </h3>
                </div>
                <p style={{ color: DIM, fontSize: '0.9rem', lineHeight: 1.65 }}>{card.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ─── COMPARISON TABLE ─── */}
      <section id="comparison" className="section-pad" style={{ padding: '96px 40px', background: DARK }}>
            ...
            <table className="comparison-table">
              <thead>
                <tr>
                  ...
                  <th style={{
                    ...
                    <span style={{ color: TEXT, fontWeight: 600, fontSize: '1.05rem' }}>Saguaro</span>
              ...
              <tbody>
                {[
                  ...
                  ['Field App', 'Free native iOS app', 'Paid add-on + IT setup', true, false],
              ...
              {[
                ...
                <div key={step.n} className="step-card">
                  <div style={{
                    ...
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    margin: '0 auto 20px',
                    fontWeight: 600, fontSize: '1.1rem', color: TEXT,
                    position: 'relative', zIndex: 1,
                  }}>
                    {step.n}
                  </div>
                  <h3 style={{ fontSize: '1rem', fontWeight: 600, color: TEXT, marginBottom: 12 }}>
                    {step.title}
                  </h3>
      ...
      {/* ─── COST CALCULATOR ─── */}
      <section className="section-pad" style={{ padding: '96px 40px', background: DARK }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{
            ...
            {/* Savings display */}
            <div style={{ margin: '40px 0 32px', padding: '28px', background: 'rgba(255,255,255,0.02)', borderRadius: 14, border: `1px solid rgba(255,255,255,0.08)` }}>
              <div style={{ fontSize: '0.8rem', color: DIM, fontWeight: 500, letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: 12 }}>
                You save
              </div>
              <div style={{
            ...
            {savings > 0 && (
              <div className="savings-display">
                <div style={{
                  ...
                  <div style={{ color: TEXT, fontSize: '1.5rem', fontWeight: 600 }}>
            ...
            <div style={{ marginTop: 36 }}>
              <Link href="/signup" className="btn-amber" style={{ padding: '13px 24px', fontSize: '0.95rem', borderRadius: 8, width: '100%', textAlign: 'center' }}>
          ...
          <div className="testimonials-grid">
            {[
              ...
              <div key={t.name} className="testimonial-card">
                <div style={{
                  fontSize: '3rem', lineHeight: 1, color: 'rgba(255,255,255,0.18)',
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                  <div style={{
                    ...
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontWeight: 600, fontSize: '0.9rem', color: TEXT, flexShrink: 0,
                  }}>
                    {t.initials}
                  </div>
                  <div>
                    <div style={{ fontWeight: 600, color: TEXT, fontSize: '0.95rem' }}>{t.name}</div>
                  ...
                  <div style={{ marginLeft: 'auto' }}>
                    <span style={{
                      ...
                      fontSize: '0.72rem', fontWeight: 500, color: DIM,
                    }}>
                      {t.tag}
                    </span>
                  </div>
      ...
      {/* ─── FINAL CTA ─── */}
      <section style={{
        background: `linear-gradient(135deg, #141416 0%, #0a0a0a 40%, #0a0a0a 60%, #141416 100%)`,
        ...
        <div style={{ position: 'relative', maxWidth: 640, margin: '0 auto' }}>
          <h2 style={{ fontSize: '1.6rem', fontWeight: 600, marginBottom: 16, lineHeight: 1.2, color: TEXT }}>
            Ready to Make the Switch?
          </h2>
          <p style={{ fontSize: '1rem', color: DIM, marginBottom: 40, lineHeight: 1.65 }}>
          ...
          <Link href="/signup" style={{
            ...
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLAnchorElement).style.background = '#E8940A';
            }}
            onMouseLeave={(e) => {
