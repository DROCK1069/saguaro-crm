...
export const metadata: Metadata = {
  ...
  description: 'Switch from Procore to Saguaro in 1 business day. Free data migration, no implementation consultant, flat pricing starting at $299/mo. AI features Procore doesn\'t have.',
  ...
  openGraph: {
    ...
    description: 'Join 500+ GC teams who switched. Free data migration, 1-day setup, AI takeoff included. $299/mo flat vs Procore\'s $1,850+/mo.',
