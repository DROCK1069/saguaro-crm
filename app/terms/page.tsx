...
export default function TermsPage(){
  return (
    <div style={{minHeight:'100vh',background:DARK,color:TEXT,fontFamily:'system-ui,sans-serif'}}>
      <nav style={{position:'fixed' as const,top:0,left:0,right:0,zIndex:100,height:56,background:'rgba(20,20,22,.96)',borderBottom:`1px solid ${BORDER}`,display:'flex',alignItems:'center',padding:'0 32px',backdropFilter:'blur(12px)'}}>
      ...
      <div style={{maxWidth:780,margin:'0 auto',padding:'88px 32px 60px'}}>
        ...
        {[
          {h:'1. Acceptance of Terms',b:'By accessing or using Saguaro Control Systems ("Service"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service. These terms apply to all users, including free trial users and paid subscribers.'},
          {h:'2. Service Description',b:'Saguaro Control Systems is a construction project management and document automation platform. We provide tools for bid management, pay applications, lien waiver generation, document automation, and related construction workflow features.'},
          ...
          {h:'8. Intellectual Property',b:'Saguaro Control Systems, its features, and underlying technology are owned by Saguaro Control Systems. Document templates generated using our Service are yours to use. You may not reverse engineer or resell the Service without our written consent.'},
          ...
          {h:'12. Contact',b:'For legal questions: legal@saguarocontrol.net · Saguaro Control Systems · Scottsdale, AZ 85251'},
        ].map(s=>(
