  ...
  return (
    <div style={{ minHeight: '100vh', background: C.dark, color: C.text, fontFamily: C.font }}>
      ...
      <div style={{ paddingTop: 64 }}>
        ...
        {/* Hero */}
        <section style={{ textAlign: 'center', padding: '88px 24px 72px', background: C.dark }}>
          ...
          <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <a href="/features" style={{ display: 'inline-block', padding: '15px 36px', background: 'transparent', border: `1.5px solid ${C.text}`, borderRadius: 10, color: C.text, fontWeight: 700, fontSize: 16, textDecoration: 'none' }}>
              Explore Features
            </a>
          </div>
        </section>
        ...
        <section style={{ padding: '0 24px 80px', maxWidth: 920, margin: '0 auto' }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ position: 'absolute', left: 27, top: 24, bottom: 24, width: 2, background: 'linear-gradient(180deg, rgba(200,136,28,0.35), #E7E5E1)', zIndex: 0 }} />
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              {STEPS.map((step, i) => (
                <div key={step.title} style={{ display: 'flex', gap: 24, alignItems: 'flex-start', position: 'relative', zIndex: 1, borderTop: '1px solid #E7E5E1', padding: '28px 0' }}>
                  <div style={{ flexShrink: 0, width: 56, height: 56, borderRadius: 16, background: 'rgba(200,136,28,0.10)', border: '1px solid rgba(200,136,28,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24, fontWeight: 900, color: '#C8881C' }}>
                    {i + 1}
                  </div>
                  <div style={{ flex: 1 }}>
        ...
        {/* Migrate in 1 day */}
        <section style={{ padding: '0 0 80px', margin: '0 auto 80px' }}>
          <div style={{ background: '#FAFAF8', borderTop: '1px solid #E7E5E1', borderBottom: '1px solid #E7E5E1', padding: '40px 48px', display: 'flex', gap: 48, alignItems: 'center', flexWrap: 'wrap', maxWidth: 900, margin: '0 auto' }}>
        ...
        {/* Final CTA */}
        <section style={{ padding: '96px 24px', background: C.dark, borderTop: `1px solid ${C.border}`, textAlign: 'center' }}>
          <div style={{ maxWidth: 640, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 40 }}>
              ...
              <a href="/pricing" style={{ display: 'inline-block', padding: '15px 36px', background: 'transparent', border: `1.5px solid ${C.text}`, borderRadius: 10, color: C.text, fontWeight: 700, fontSize: 16, textDecoration: 'none' }}>
                View Pricing
              </a>
            </div>
