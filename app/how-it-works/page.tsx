  ...
  return (
    <div style={{ minHeight: '100vh', background: C.dark, color: C.text, fontFamily: C.font }}>
      ...
      <div style={{ paddingTop: 64 }}>
        ...
        {/* Hero */}
        <section style={{ textAlign: 'center', padding: '88px 24px 72px', background: `radial-gradient(ellipse 900px 500px at 50% 0%, rgba(212,160,23,0.07) 0%, transparent 70%)` }}>
        ...
        <section style={{ padding: '0 24px 80px', maxWidth: 920, margin: '0 auto' }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ position: 'absolute', left: 27, top: 24, bottom: 24, width: 2, background: `linear-gradient(180deg, rgba(212,160,23,0.4), ${C.border})`, zIndex: 0 }} />
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              {STEPS.map((step, i) => (
                <div key={step.title} style={{ display: 'flex', gap: 24, alignItems: 'flex-start', position: 'relative', zIndex: 1 }}>
                  <div style={{ flexShrink: 0, width: 56, height: 56, borderRadius: 16, background: 'linear-gradient(135deg, rgba(212,160,23,0.18), rgba(212,160,23,0.06))', border: `1px solid rgba(212,160,23,0.30)`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24, fontWeight: 900, color: C.gold, boxShadow: '0 4px 14px rgba(0,0,0,.45)' }}>
                    {i + 1}
                  </div>
                ...
                {MIGRATION_POINTS.map(item => (
                  <div key={item} style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                    <svg width={15} height={15} viewBox="0 0 16 16" fill="none" style={{ flexShrink: 0 }}>
                      <circle cx="8" cy="8" r="8" fill="rgba(212,160,23,0.14)" />
