    ...
    <div style={{ minHeight: '100vh', background: C.dark, color: C.text, fontFamily: C.font }}>
      ...
      <div style={{ paddingTop: 64 }}>
        ...
        <section style={{ padding: '0 24px 80px', maxWidth: 1100, margin: '0 auto' }}>
            ...
            {POSTS.map(post => (
              <a key={post.title} href={post.href} style={{ textDecoration: 'none', display: 'block' }}>
                <article style={{
                  ...
                  padding: '28px 26px', height: '100%', boxSizing: 'border-box',
                  display: 'flex', flexDirection: 'column', boxShadow: '0 4px 14px rgba(0,0,0,.40)',
                }}>
          ...
          {/* More coming soon */}
          <div style={{ marginTop: 40, textAlign: 'center', padding: '32px 24px', background: C.raised, border: `1px dashed ${C.border}`, borderRadius: 14 }}>
        ...
        <section style={{ padding: '88px 24px', background: `linear-gradient(180deg, transparent 0%, rgba(212,160,23,0.05) 50%, transparent 100%)`, borderTop: `1px solid ${C.border}`, textAlign: 'center' }}>
          <div style={{ maxWidth: 640, margin: '0 auto' }}>
            <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 900, margin: '0 0 16px', lineHeight: 1.15, letterSpacing: -0.8 }}>
              ...
              <span style={{ background: `linear-gradient(135deg, ${C.gold}, ${C.goldBright})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Run a real bid.</span>
            </h2>
