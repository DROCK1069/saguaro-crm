  ...
  const inp = (label: string, key: string, placeholder?: string, type?: string) => (
    <div style={{ marginBottom: 16 }}>
      ...
      <input
        ...
        style={{ width: '100%', background: '#1c1c1e', border: `1px solid ${BORDER}`, borderRadius: 7, padding: '10px 14px', color: TEXT, fontSize: 14, outline: 'none', boxSizing: 'border-box' }}
      />
    </div>
  );
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '32px 24px' }}>
        ...
        <form onSubmit={submit}>
            ...
            <div style={{ padding: 20 }}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <select
                  ...
                  style={{ width: '100%', background: '#1c1c1e', border: `1px solid ${BORDER}`, borderRadius: 7, padding: '10px 14px', color: TEXT, fontSize: 14, outline: 'none' }}
                >
            ...
            <div style={{ padding: 20 }}>
              ...
              <div style={{ marginBottom: 8 }}>
                ...
                <input
                  ...
                  maxLength={11}
                  style={{ width: '100%', background: '#1c1c1e', border: `1px solid ${BORDER}`, borderRadius: 7, padding: '10px 14px', color: TEXT, fontSize: 14, outline: 'none', boxSizing: 'border-box', letterSpacing: 2 }}
                />
          ...
          <div style={{ background: RAISED, border: `1px solid ${BORDER}`, borderRadius: 10, overflow: 'hidden', marginBottom: 20 }}>
            ...
            <div style={{ padding: 20 }}>
              <div style={{ fontSize: 12, color: DIM, lineHeight: 1.7, marginBottom: 16, background: '#1c1c1e', borderRadius: 6, padding: '12px 14px' }}>
