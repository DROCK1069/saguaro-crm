    ...
    <div style={{ minHeight: '100vh', background: BG, padding: '24px 16px' }}>
      <div style={{ maxWidth: 560, margin: '0 auto' }}>
        ...
        <div style={{ background: CARD, border: `1px solid ${BORDER_LT}`, borderRadius: 12, padding: 20, marginBottom: 16, boxShadow: '0 1px 4px rgba(0,0,0,.04)' }}>
          ...
          {/* Mode Toggle */}
          <div style={{ display: 'flex', gap: 4, marginBottom: 14, background: '#1c1c1e', borderRadius: 8, padding: 3 }}>
          ...
          {mode === 'draw' ? (
            ...
            <div>
              ...
              />
              {typedName.trim() && (
                <div style={{ marginTop: 12, padding: '16px 20px', border: `1px solid ${BORDER_LT}`, borderRadius: 8, background: '#1c1c1e' }}>
