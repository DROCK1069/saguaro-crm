...
export default function ClientPortalPage() {
  ...
  const renderDashboard = () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      {/* Welcome Banner */}
      <div style={{ ...cardStyle, background: `linear-gradient(135deg, ${RAISED} 0%, #1c1c1e 100%)`, position: 'relative', overflow: 'hidden' }}>
                ...
                <button
                  ...
                  onClick={() => {
                    if (doc.url) {
                      ...
                      showToast('This document isn’t available for download yet. Please contact your contractor.', 'error');
                    }
                  }}
                >
                  ⬇ Download
        ...
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12, paddingTop: 12, borderTop: `1px solid ${BORDER}44` }}>
            ...
            <div style={{ display: 'flex', gap: 16, fontSize: 11, color: DIM }}>
              <Link href="/help-center" target="_blank" rel="noopener noreferrer" style={{ color: DIM, textDecoration: 'none', cursor: 'pointer' }}>Help</Link>
