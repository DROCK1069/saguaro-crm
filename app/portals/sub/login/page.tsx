          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              style={{
                ...
                marginTop: 16,
                padding: '13px',
                background: loading || !email.trim() ? 'rgba(245,158,11,0.3)' : BLUE,
                border: 'none',
                borderRadius: 8,
                color: '#fff',
                fontSize: 15,
            ...
            {/* Have a direct link */}
            <div style={{ marginTop: 16, padding: '12px 14px', background: '#1c1c1e', border: `1px solid ${BORDER}`, borderRadius: 8 }}>
