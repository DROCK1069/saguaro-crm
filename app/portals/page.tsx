...
export default function PortalsHub() {
  const portals = [
    { title: 'Owner / Client Portal', desc: 'View project progress, budgets, photos, and documents', href: '/portals/client', color: '#C8881C' },
        ...
        <div style={{ display: 'grid', gap: 16 }}>
          {portals.map((p) => (
            <a key={p.href} href={p.href} style={{
              ...
              background: 'rgba(0,0,0,0.04)', backdropFilter: 'blur(40px)',
