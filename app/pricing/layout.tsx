...
export const metadata: Metadata = {
  ...
  description: 'Saguaro CRM pricing: Starter $399/mo, Professional $799/mo, Enterprise custom. Free migration from Procore or Buildertrend. Flat pricing — unlimited users. No per-seat fees.',
  ...
  openGraph: {
    ...
    description: 'Starter $399/mo, Professional $799/mo. Free migration from Procore or Buildertrend. Unlimited users, no per-seat fees.',
