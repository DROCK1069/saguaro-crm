              ...
              {selected.map((m) => {
                ...
                return (
                  <div key={m.id} style={{
                    ...
                    border: `1px solid ${m.coRisk === 'red' ? 'rgba(192,48,48,0.3)' : m.coRisk === 'amber' ? 'rgba(212,154,23,0.3)' : 'rgba(255,255,255,0.12)'}`,
                  }}>
                    ...
                    {/* Approval likelihood */}
                    <div style={{
                      marginTop: 12, background: 'rgba(245, 158, 11,0.06)', borderRadius: 6,
