...
export default function SpecsPage(){
  ...
  const rows=[['03','03 31 00','Structural Concrete','2026-01-15','Current'],['06','06 10 00','Rough Carpentry','2026-01-15','Current'],['09','09 21 16','Gypsum Board','2026-01-15','Current'],['26','26 05 00','Common Work — Electrical','2026-01-15','Current']];
  ...
  return <div>
    <div style={{padding:'16px 24px',borderBottom:'1px solid '+BORDER,display:'flex',alignItems:'center',justifyContent:'space-between',background:'#0d1117'}}>
      <div><h2 style={{margin:0,fontSize:20,fontWeight:800,color:TEXT}}>📖 Specs</h2><div style={{fontSize:12,color:DIM,marginTop:3}}>Project specifications by CSI division</div></div>
    ...
    {showNew&&<div style={{margin:24,background:RAISED,border:'1px solid rgba(212,160,23,.3)',borderRadius:10,padding:24}}>
      <div style={{fontSize:13,fontWeight:700,color:TEXT,marginBottom:12}}>Add New Specs</div>
    ...
    <div style={{padding:'0 24px 24px'}}>
      <table style={{width:'100%',borderCollapse:'collapse',fontSize:13,marginTop:24}}>
        <thead><tr style={{background:'#0a1117'}}>
          {['Division','Section','Title','Version','Status'].map(h=><th key={h} style={{padding:'10px 14px',textAlign:'left',fontSize:11,fontWeight:700,textTransform:'uppercase',letterSpacing:.5,color:DIM,borderBottom:'1px solid '+BORDER}}>{h}</th>)}
        </tr></thead>
