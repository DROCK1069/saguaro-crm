...
export default function PermitsPage(){
  ...
  const rows=[['2026-BP-4421','Building','City of Phoenix','2026-01-12','2027-01-12','Active'],['2026-EP-1102','Electrical','City of Phoenix','2026-01-15','2027-01-15','Active'],['2026-MP-0882','Mechanical','City of Phoenix','2026-01-15','2027-01-15','Active']];
  ...
  return <div>
    <div style={{padding:'16px 24px',borderBottom:'1px solid '+BORDER,display:'flex',alignItems:'center',justifyContent:'space-between',background:'#0d1117'}}>
      <div><h2 style={{margin:0,fontSize:20,fontWeight:800,color:TEXT}}>🏛️ Permits</h2><div style={{fontSize:12,color:DIM,marginTop:3}}>Building permits and approvals</div></div>
    ...
    {showNew&&<div style={{margin:24,background:RAISED,border:'1px solid rgba(212,160,23,.3)',borderRadius:10,padding:24}}>
      <div style={{fontSize:13,fontWeight:700,color:TEXT,marginBottom:12}}>Add New Permits</div>
    ...
    <div style={{padding:'0 24px 24px'}}>
      <table style={{width:'100%',borderCollapse:'collapse',fontSize:13,marginTop:24}}>
        <thead><tr style={{background:'#0a1117'}}>
          {['Permit #','Type','Agency','Issued','Expires','Status'].map(h=><th key={h} style={{padding:'10px 14px',textAlign:'left',fontSize:11,fontWeight:700,textTransform:'uppercase',letterSpacing:.5,color:DIM,borderBottom:'1px solid '+BORDER}}>{h}</th>)}
        </tr></thead>
