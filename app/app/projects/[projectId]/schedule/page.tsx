...
export default function SchedulePage(){
  ...
  const rows=[['Site Preparation','2026-01-08','2026-01-21','2 weeks','Chad D.','Complete'],['Foundation','2026-01-22','2026-02-07','2.5 weeks','Jose M.','Complete'],['Framing','2026-02-08','2026-03-07','4 weeks','Mike T.','In Progress'],['Rough MEP','2026-03-08','2026-04-05','4 weeks','Various','Upcoming'],['Insulation & Drywall','2026-04-06','2026-05-03','4 weeks','Various','Upcoming'],['Finish Work','2026-05-04','2026-07-12','10 weeks','Various','Upcoming'],['Punch List','2026-07-13','2026-08-02','3 weeks','Chad D.','Upcoming'],['Substantial Completion','2026-08-03','2026-08-03','1 day','Chad D.','Upcoming']];
  ...
  return <div>
    <div style={{padding:'16px 24px',borderBottom:'1px solid '+BORDER,display:'flex',alignItems:'center',justifyContent:'space-between',background:'#0d1117'}}>
      <div><h2 style={{margin:0,fontSize:20,fontWeight:800,color:TEXT}}>📅 Schedule</h2><div style={{fontSize:12,color:DIM,marginTop:3}}>Project schedule and milestones</div></div>
    ...
    {showNew&&<div style={{margin:24,background:RAISED,border:'1px solid rgba(212,160,23,.3)',borderRadius:10,padding:24}}>
      <div style={{fontSize:13,fontWeight:700,color:TEXT,marginBottom:12}}>Add New Schedule</div>
    ...
    <div style={{padding:'0 24px 24px'}}>
      <table style={{width:'100%',borderCollapse:'collapse',fontSize:13,marginTop:24}}>
        <thead><tr style={{background:'#0a1117'}}>
          {['Phase','Start','End','Duration','Lead','Status'].map(h=><th key={h} style={{padding:'10px 14px',textAlign:'left',fontSize:11,fontWeight:700,textTransform:'uppercase',letterSpacing:.5,color:DIM,borderBottom:'1px solid '+BORDER}}>{h}</th>)}
        </tr></thead>
