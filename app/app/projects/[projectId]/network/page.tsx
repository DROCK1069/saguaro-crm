        ...
        <div style={cardStyle}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <button
              ...
              disabled={creating}
              style={{
                padding: '12px 24px', background: `linear-gradient(135deg, ${GOLD}, #E0A030)`, color: '#000',
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
          {[
            ...
            <Link
              ...
              style={{
                padding: '8px 16px', background: 'rgba(0,0,0,0.05)', border: `1px solid ${BORDER}`,
          ...
          Object.entries(devicesByType).map(([type, devs]) => (
            <div key={type} style={{ marginBottom: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                ...
                <span style={{
                  background: 'rgba(0,0,0,0.06)', color: DIM, fontSize: 11, padding: '2px 8px',
        ...
        <div style={{ ...cardStyle }}>
          ...
          {alerts.filter(a => !a.resolved).map(alert => (
            <div key={alert.id} style={{
              ...
              background: alert.severity === 'critical' ? `${RED}10` : 'rgba(0,0,0,0.03)',
