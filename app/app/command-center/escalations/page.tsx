...
export default function EscalationsPage() {
  ...
  const pill: React.CSSProperties = { fontSize: 11, fontWeight: 600, padding: '3px 8px', borderRadius: 6, background: '#16243A', color: C.dim };
  ...
  return (
    <div style={{ padding: '28px 24px 60px', maxWidth: 1280, margin: '0 auto', fontFamily: font, color: C.text }}>
      ...
      {loading ? (
        ...
        rows.length === 0 ? (
          <EmptyState icon="🚩" title="No escalations"
