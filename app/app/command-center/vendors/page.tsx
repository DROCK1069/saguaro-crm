...
export default function VendorsPage() {
  ...
  return (
    <div style={{ padding: '28px 24px 60px', maxWidth: 1200, margin: '0 auto', fontFamily: font, color: C.text }}>
      ...
      : rows.length === 0 ? (
        <EmptyState icon={<Truck size={34} weight="regular" color={C.dim} />} title="No vendor deliveries scheduled" body="Long-lead procurement and equipment installs (Full-Swing, AV, switchgear) appear here as a coordinated cross-site timeline." />
      ) : (
