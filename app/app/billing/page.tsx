...
const PLANS = [
  ...
  },
  {
    ...
    price_mo: 1299,
    price_yr: 1083,
    tagline: 'For larger GCs & multi-crew operations · 50+ person teams',
    features: ['Everything in Professional', 'Priority SLA — 99.9% uptime', 'QuickBooks sync included', 'Advanced analytics & reporting', 'Dedicated onboarding', 'Phone + priority chat support (1hr response)'],
  },
  {
    id: 'enterprise',
    name: 'Enterprise',
