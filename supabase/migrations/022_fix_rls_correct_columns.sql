-- ============================================================
-- MIGRATION 022: Fix RLS with correct column mapping per table
...
-- ============================================================
-- GENERATED DOCUMENTS — has tenant_id (text)
-- ============================================================
...
-- ============================================================
-- INSURANCE CERTIFICATES — has tenant_id (text)
-- ============================================================
...
-- ============================================================
-- NOTIFICATIONS — has tenant_id (text)
-- ============================================================
...
-- ============================================================
-- PAYROLL RECORDS — has tenant_id (text)
-- ============================================================
...
-- ============================================================
-- REPORT RUNS — has tenant_id (text)
-- ============================================================
...
-- ============================================================
-- W9 REQUESTS — has tenant_id (text)
-- ============================================================
...
-- ============================================================
-- LIEN WAIVERS — project_id (text), join through projects
-- ============================================================
...
-- ============================================================
-- PAY APPLICATIONS — project_id (text), join through projects
-- ============================================================
...
-- ============================================================
-- TAKEOFFS — project_id (uuid), join through projects
-- ============================================================
...
CREATE POLICY "tenant_takeoff_materials_select" ON public.takeoff_materials
  FOR SELECT USING (
    takeoff_id IN (
      SELECT t.id FROM public.takeoffs t
...
-- ============================================================
-- DOCUMENTS — user_id (uuid) only, no tenant_id
-- ============================================================
CREATE POLICY "owner_documents_select" ON public.documents
  FOR SELECT USING (user_id = auth.uid());
CREATE POLICY "owner_documents_insert" ON public.documents
  FOR INSERT WITH CHECK (user_id = auth.uid());
CREATE POLICY "owner_documents_update" ON public.documents
  FOR UPDATE USING (user_id = auth.uid());
CREATE POLICY "owner_documents_delete" ON public.documents
