...
export const C = {
  ...
  bg: '#0a0a0a', card: '#141416', border: 'rgba(255,255,255,0.12)', dim: '#CBD5E1', text: '#FFFFFF', faint: '#CBD5E1',
};
...
export function Metric({ label, value, color }: { label: React.ReactNode; value: React.ReactNode; color?: string }) {
  return (
    <div>
