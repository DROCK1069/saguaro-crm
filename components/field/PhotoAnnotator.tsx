...
const COLORS = ['#EF4444', '#F59E0B', '#22C55E', '#F59E0B', '#A855F7', '#FFFFFF'];
      ...
      {!imgSrc ? (
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16, padding: 24 }}>
          ...
          <button
            ...
            style={{ padding: '12px 28px', background: GOLD, border: 'none', borderRadius: 10, color: '#1C1C1E', fontWeight: 700, fontSize: 15, cursor: 'pointer' }}
          >
            Choose Photo
          </button>
