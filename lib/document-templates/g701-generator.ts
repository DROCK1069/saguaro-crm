...
export async function generateG701(input: G701Input): Promise<{
  ...
  page.drawText(toWinAnsi('AIA DOCUMENT G701 \u2014 CHANGE ORDER'), {
    x: 10,
    y: height - 26,
    size: 13,
    font: bold,
  ...
  y -= 18;
  page.drawText(toWinAnsi('DESCRIPTION OF CHANGE'), {
    x: 10,
    y,
    size: 11,
    font: bold,
  ...
  for (const word of descWords) {
    if ((descLine + ' ' + word).length > 95) {
      page.drawText(toWinAnsi(descLine.trim()), {
        x: 10,
        y,
        size: 8.5,
        font,
  ...
  y -= 10;
  page.drawText(toWinAnsi('COST IMPACT'), {
    x: 10,
    y,
    size: 10,
    font: bold,
  ...
  y -= 14;
  page.drawText(toWinAnsi(`Amount: ${fmtCurrency(co?.cost_impact || co?.amount || 0)}`), {
    x: 15,
    y,
    size: 9,
    font,
  ...
  y -= 18;
  page.drawText(toWinAnsi('SCHEDULE IMPACT'), {
    x: 10,
    y,
    size: 10,
    font: bold,
  ...
  y -= 15;
  page.drawText(toWinAnsi('FINANCIAL SUMMARY'), {
    x: 10,
    y,
    size: 10,
    font: bold,
  ...
  // Footer
  page.drawText(
    toWinAnsi(`Generated by Saguaro CRM  \u2022  ${new Date().toLocaleDateString()}  \u2022  AIA G701`),
