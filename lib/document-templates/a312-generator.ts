...
export async function generateA312(input: A312Input): Promise<{
  ...
  page1.drawText(
    `Generated by Saguaro Control Systems  \u2022  ${new Date().toLocaleDateString()}  \u2022  AIA A312 Performance Bond`,
  ...
  page2.drawText(
    `Generated by Saguaro Control Systems  \u2022  ${new Date().toLocaleDateString()}  \u2022  AIA A312 Payment Bond`,
    { x: 10, y: 15, size: 7, font, color: rgb(0.6, 0.6, 0.6) }
  );
