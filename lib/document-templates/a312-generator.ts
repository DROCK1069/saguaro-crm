...
export async function generateA312(input: A312Input): Promise<{
  ...
  page1.drawText(toWinAnsi('AIA DOCUMENT A312 \u2014 PERFORMANCE BOND'), {
    x: 10,
    y: height - 26,
    size: 13,
    font: bold,
  ...
  page1.drawText(toWinAnsi(`Bond No: ${input.bondNumber}  \u2022  SAGUARO CONSTRUCTION INTELLIGENCE PLATFORM`), {
    x: 10,
    y: height - 36,
    size: 7,
    font,
  ...
  page1.drawText(toWinAnsi('PERFORMANCE BOND AMOUNT (100% of Contract):'), {
    x: 20,
    y: y + 7,
    size: 10,
    font: bold,
  ...
  page1.drawText(toWinAnsi(fmtCurrency(bondAmount)), {
    x: 400,
    y: y + 7,
    size: 13,
    font: bold,
  ...
  y -= 14;
  page1.drawText(toWinAnsi('PERFORMANCE BOND — TERMS AND CONDITIONS'), {
    x: 10,
    y,
    size: 10,
    font: bold,
  ...
  for (const word of perfWords) {
    if ((perfLine + ' ' + word).length > 95) {
      page1.drawText(toWinAnsi(perfLine.trim()), {
        x: 10,
        y,
        size: 8,
        font,
  ...
  y -= 15;
  page1.drawText(
    toWinAnsi('IN WITNESS WHEREOF, the parties have hereunto set their hands and seals on the date set forth below.'),
    { x: 10, y, size: 8.5, font, color: rgb(0.2, 0.2, 0.2) }
  );

  y -= 25;
  page1.drawText(toWinAnsi('PRINCIPAL:'), {
    x: 10,
    y,
    size: 9,
    font: bold,
  ...
  page1.drawText(toWinAnsi('Signature / Title / Date'), {
    x: 10,
    y: y - 28,
    size: 7,
    font,
  ...
  page1.drawText(toWinAnsi(input.principalName), {
    x: 10,
    y: y - 38,
    size: 8,
    font,
  ...
  page1.drawText(toWinAnsi('SURETY:'), {
    x: 310,
    y,
    size: 9,
    font: bold,
  ...
  page1.drawText(toWinAnsi('Attorney-in-Fact / Date'), {
    x: 310,
    y: y - 28,
    size: 7,
    font,
  ...
  page1.drawText(toWinAnsi(input.suretyName), {
    x: 310,
    y: y - 38,
    size: 8,
    font,
  ...
  page1.drawText(
    toWinAnsi(`Generated by Saguaro CRM  \u2022  ${new Date().toLocaleDateString()}  \u2022  AIA A312 Performance Bond`),
  ...
  page2.drawText(toWinAnsi('AIA DOCUMENT A312 \u2014 PAYMENT BOND'), {
    x: 10,
    y: height - 26,
    size: 13,
    font: bold,
  ...
  page2.drawText(toWinAnsi(`Bond No: ${input.bondNumber}  \u2022  SAGUARO CONSTRUCTION INTELLIGENCE PLATFORM`), {
    x: 10,
    y: height - 36,
    size: 7,
    font,
  ...
  page2.drawText(toWinAnsi('PAYMENT BOND AMOUNT (100% of Contract):'), {
    x: 20,
    y: y2 + 7,
    size: 10,
    font: bold,
  ...
  page2.drawText(toWinAnsi(fmtCurrency(bondAmount)), {
    x: 400,
    y: y2 + 7,
    size: 13,
    font: bold,
  ...
  y2 -= 14;
  page2.drawText(toWinAnsi('PAYMENT BOND \u2014 TERMS AND CONDITIONS'), {
    x: 10,
    y: y2,
    size: 10,
    font: bold,
  ...
  for (const word of payWords) {
    if ((payLine + ' ' + word).length > 95) {
      page2.drawText(toWinAnsi(payLine.trim()), {
        x: 10,
        y: y2,
        size: 8,
        font,
  ...
  y2 -= 25;
  page2.drawText(toWinAnsi('PRINCIPAL:'), {
    x: 10,
    y: y2,
    size: 9,
    font: bold,
  ...
  page2.drawText(toWinAnsi('Signature / Title / Date'), {
    x: 10,
    y: y2 - 28,
    size: 7,
    font,
  ...
  page2.drawText(toWinAnsi(input.principalName), {
    x: 10,
    y: y2 - 38,
    size: 8,
    font,
  ...
  page2.drawText(toWinAnsi('SURETY:'), {
    x: 310,
    y: y2,
    size: 9,
    font: bold,
  ...
  page2.drawText(toWinAnsi('Attorney-in-Fact / Date'), {
    x: 310,
    y: y2 - 28,
    size: 7,
    font,
  ...
  page2.drawText(toWinAnsi(input.suretyName), {
    x: 310,
    y: y2 - 38,
    size: 8,
    font,
  ...
  page2.drawText(
    toWinAnsi(`Generated by Saguaro CRM  \u2022  ${new Date().toLocaleDateString()}  \u2022  AIA A312 Payment Bond`),
    { x: 10, y: 15, size: 7, font, color: rgb(0.6, 0.6, 0.6) }
  );
