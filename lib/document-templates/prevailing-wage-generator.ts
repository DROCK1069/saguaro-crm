...
export async function generatePrevailingWage(input: PrevailingWageInput): Promise<{
  ...
  page.drawText('PREVAILING WAGE RATE SCHEDULE', {
    x: 10,
    y: height - 26,
    size: 12,
    font: bold,
  ...
  // Subtitle — honest about what this is.
  let y = height - 55;
  page.drawText(
    allCustom
  ...
  // Footer
  page.drawText(
    `Generated by Saguaro Control Systems  •  ${new Date().toLocaleDateString()}  •  Prevailing Wage`,
