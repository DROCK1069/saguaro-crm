...
export async function generateSubcontract(input: SubcontractInput): Promise<{
  ...
  page1.drawText(toWinAnsi('SUBCONTRACT AGREEMENT'), {
    x: 10,
    y: height - 26,
    size: 13,
    font: bold,
  ...
  page1.drawText(toWinAnsi('SAGUARO CONSTRUCTION INTELLIGENCE PLATFORM  \u2022  AIA A401 STYLE'), {
    x: 10,
    y: height - 36,
    size: 7,
    font,
  ...
  // Article 1
  y -= 10;
  page1.drawText(toWinAnsi('ARTICLE 1 \u2014 THE SUBCONTRACT DOCUMENTS'), {
    x: 10,
    y,
    size: 10,
    font: bold,
  ...
  // Article 2
  y -= 10;
  page1.drawText(toWinAnsi('ARTICLE 2 \u2014 SCOPE OF WORK'), {
    x: 10,
    y,
    size: 10,
    font: bold,
  ...
  y -= 10;
  page1.drawText(toWinAnsi('ARTICLE 3 \u2014 SUBCONTRACT SUM'), {
    x: 10,
    y,
    size: 10,
    font: bold,
  ...
  page1.drawText(toWinAnsi('SUBCONTRACT SUM:'), {
    x: 20,
    y: y + 7,
    size: 11,
    font: bold,
  ...
  page1.drawText(toWinAnsi(fmtCurrency(subAmount)), {
    x: 380,
    y: y + 7,
    size: 13,
    font: bold,
  ...
  // Footer page 1
  page1.drawText(
    toWinAnsi(`Generated by Saguaro CRM  \u2022  ${new Date().toLocaleDateString()}  \u2022  Subcontract Agreement`),
  ...
  // Article 4
  page2.drawText(toWinAnsi('ARTICLE 4 \u2014 PAYMENT'), {
    x: 10,
    y,
    size: 10,
    font: bold,
  ...
  // Article 5
  y -= 15;
  page2.drawText(toWinAnsi('ARTICLE 5 \u2014 INSURANCE REQUIREMENTS'), {
    x: 10,
    y,
    size: 10,
    font: bold,
  ...
  // Article 6
  y -= 15;
  page2.drawText(toWinAnsi('ARTICLE 6 \u2014 INDEMNIFICATION'), {
    x: 10,
    y,
    size: 10,
    font: bold,
  ...
  // Article 7
  y -= 15;
  page2.drawText(toWinAnsi('ARTICLE 7 \u2014 TERMINATION'), {
    x: 10,
    y,
    size: 10,
    font: bold,
  ...
  y -= 15;
  page2.drawText(toWinAnsi('IN WITNESS WHEREOF, the parties have executed this Subcontract Agreement.'), {
    x: 10,
    y,
    size: 9,
    font,
  ...
  page2.drawText(toWinAnsi('CONTRACTOR:'), { x: 10, y, size: 9, font: bold, color: rgb(0, 0, 0) });
  page2.drawText(toWinAnsi(contractorName), {
    x: 10,
    y: y - 12,
    size: 8,
    font,
  ...
  page2.drawText(toWinAnsi('SUBCONTRACTOR:'), {
    x: 310,
    y,
    size: 9,
    font: bold,
  ...
  page2.drawText(toWinAnsi(subName), {
    x: 310,
    y: y - 12,
    size: 8,
    font,
