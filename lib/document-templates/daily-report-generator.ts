...
export async function generateDailyReport(input: DailyReportInput): Promise<{
  ...
  page.drawText(toWinAnsi('DAILY CONSTRUCTION REPORT'), {
    x: 10,
    y: height - 26,
    size: 12,
    font: bold,
  ...
  y -= 10;
  page.drawText(toWinAnsi('Superintendent Signature / Date'), {
    x: 10, y, size: 8, font, color: rgb(0.5, 0.5, 0.5),
  });

  // Footer
  page.drawText(
    toWinAnsi(`Generated by Saguaro CRM  \u2022  ${new Date().toLocaleDateString()}  \u2022  Daily Report`),
