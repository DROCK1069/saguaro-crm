...
function footerText(page: any, reg: any, branding: DocBranding = SAGUARO_BRANDING) {
  ...
  const who = branding.whiteLabel ? branding.companyName : 'Saguaro CRM';
...
export async function generateW9(input: {
  ...
  page.drawText(`Generated by Saguaro Control on ${fmtDate(new Date())}`, { x: M, y: 30, size: 7.5, font: reg, color: GRAY });
  return doc.save();
}
