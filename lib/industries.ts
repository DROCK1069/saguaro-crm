...
export const INDUSTRIES: Industry[] = [
  {
    ...
    testimonialName: '',
    testimonialTitle: '',
    testimonialQuote: 'Material takeoffs that used to take half a day are done in about a minute — upload the PDF and get the numbers. It changes how a GC bids.',
  ...
  },
  {
    ...
    testimonialName: '',
    testimonialTitle: '',
    testimonialQuote: 'The lien waiver module handles 30–40 waivers a month across multiple projects and is built to cut closeout admin time dramatically.',
  ...
  },
  {
    ...
    testimonialName: '',
    testimonialTitle: '',
    testimonialQuote: 'Compared to Procore and Buildertrend, Saguaro delivers the features a commercial GC needs at a fraction of the cost — with AI that does real work, not gimmicks.',
  ...
  },
  {
    ...
    testimonialName: '',
    testimonialTitle: '',
    testimonialQuote: 'Get a whole crew onto the field app in minutes — just text them the link. GPS clock-in is built to end the Friday timesheet chase.',
  ...
  },
  {
    ...
    testimonialName: '',
    testimonialTitle: '',
    testimonialQuote: 'Full offline mode is built for basements and dead zones — the field app keeps working with no signal and syncs everything when you reconnect, so no data is lost.',
