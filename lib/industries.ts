...
export const INDUSTRIES: Industry[] = [
  {
    ...
    keyFeatures: [
      ...
      { title: 'Free Mobile Field App', desc: 'GPS clock-in, daily logs, photos, RFIs, punch lists — works offline. Native iOS app, free for your whole crew.' },
    ],
    ...
    metaTitle: 'Construction Software for General Contractors | Saguaro Control Systems',
  ...
  },
  {
    ...
    metaTitle: 'Construction Software for Residential Remodelers | Saguaro Control Systems',
  ...
  },
  {
    ...
    metaTitle: 'Commercial Construction Software for General Contractors | Saguaro Control Systems',
    metaDescription: 'Best commercial construction CRM for GCs. AI blueprint takeoff, AIA pay apps, certified payroll, multi-division bid management. Procore alternative at $499/mo.',
