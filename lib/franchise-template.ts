...
// The 8-stage rollout template + guard now live in @saguaro/core (single source
// shared with the native app's franchise-rollout / cc-rollout screens). Edit there.
export { ROLLOUT_STAGES, STAGE_IDS, STAGE_META, isStage } from '@saguaro/core';
export type { RolloutStage } from '@saguaro/core';
